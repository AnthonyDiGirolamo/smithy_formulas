class PetscdevFormula < Formula
  homepage "http://www.mcs.anl.gov/petsc/index.html"
  # url "http://ftp.mcs.anl.gov/pub/petsc/release-snapshots/petsc-3.4.3.tar.gz"
  # url "https://bitbucket.org/petsc/petsc/get/master.tar.gz"
  url "none"
  ...
  def install
    Dir.chdir prefix
    system "git clone https://bitbucket.org/petsc/petsc source" unless Dir.exists?("source")
    Dir.chdir prefix+"/source"
    system "git reset --hard"
    system "git checkout 06283fd4"
    # system "git checkout v3.4.3"
    ...
    if cray_build
      ...
      hdf5_prefix      = module_environment_variable("cray-hdf5-parallel",   "HDF5_DIR")
    else
